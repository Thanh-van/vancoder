...
<?php include_once 'template/header.php'; ?>
	<div class="hero-wrap js-fullheight" style="background-image: url('<?= host . '/' . name_project . view_font; ?>images/bg_5.jpg');">
		...
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
				...
				<a href="https://www.youtube.com/watch?v=1NtV5KgRo0c" class="icon-video popup-vimeo d-flex align-items-center justify-content-center mb-4">
...
<div id="seach_data">
					...
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
								<div class="services services-1 color-1 d-block img" style="background-image: url(<?= host . '/' . name_project . view_font; ?>images/services-1.jpg);">
							...
							<div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
								<div class="services services-1 color-2 d-block img" style="background-image: url(<?= host . '/' . name_project . view_font; ?>images/services-2.jpg);">
							...
							<div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
								<div class="services services-1 color-3 d-block img" style="background-image: url(<?= host . '/' . name_project . view_font; ?>images/services-3.jpg);">
							...
							<div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
								<div class="services services-1 color-4 d-block img" style="background-image: url(<?= host . '/' . name_project . view_font; ?>images/services-4.jpg);">
		...
		<section class="ftco-section">
			<div class="container">
				...
				<div class="row">
					<?php foreach($data['ticket'] as $ticket_arr => $ticket_key){ ?>
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url('<?= host . '/' . name_project . 'view/'; ?>upload/<?= $ticket_key['img'] ?>');">
								<span class="price">$<?= $ticket_key['price'] ?>/person</span>
							</a>
							<div class="text p-4">
								<span class="days"><?= floor( abs(strtotime($ticket_key['end_date'])  - strtotime($ticket_key['delivery_date'])) / (60*60*24) )  ?> Days Tour</span>
								<h3><a href="#"><?= $ticket_key['name'] ?></a></h3>
								<p class="location"><span class="fa fa-map-marker"></span>  <?php
                                foreach ($data['category'] as $item => $key) {
										if($key['id'] === $ticket_key['id_category'])
                                   	 	echo $key['name'];
                                    }
                                ?>
								<ul>
									<li><span class="flaticon-king-size"></span><?= $ticket_key['quantity'] ?></li>
									<li><span class="flaticon-mountains"></span><?= $ticket_key['description'] ?></li>
								</ul>
							</div>
						</div>
					</div>
		...
		<section class="ftco-section ftco-about img"style="background-image: url(<?= host . '/' . name_project . view_font; ?>images/bg_4.jpg);">
			<div class="overlay"></div>
					...
					<div class="col-md-12 about-intro">
						<div class="row">
							<div class="col-md-6 d-flex align-items-stretch">
								<div class="img d-flex w-100 align-items-center justify-content-center" style="background-image:url(<?= host . '/' . name_project . view_font; ?>images/about-1.jpg);">
								</div>
							</div>
		...
		<section class="ftco-section testimony-section bg-bottom" style="background-image: url(<?= host . '/' . name_project . view_font; ?>images/bg_1.jpg);">
			<div class="overlay"></div>
			<div class="container">
				<div class="row justify-content-center pb-4">
